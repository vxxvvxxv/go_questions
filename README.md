...
**SOLID** - подход к проектированию приложения

- **Single Responsobility Principe** - принцип единственной ответсвенности:
  - Каждый класс должен решать лишь одну задачу.
- **Open-Close Principe** - принцип открытости/закрытости:
  - классы/модули/функции должны быть открыты для расширения, но не для модификации.
- **Liskov Substitution Principe** - принцип подстановки Барбары Лисков:
  - необходимо, чтобы подклассы могли бы служить заменой для своих суперклассов.
- **Interface Segregation Principe** - принцип разделения интернфейса:
  - создавайте узко специализированные интерфейсы, предназначенные для конкретного клиента. Клиента не должны зависеть от интерфейсов, которые они не используют.
- **Dependency Inversion Principe** - принцип инверсии зависимости:
  - объектом зависимости, должна быть абстракция, а не что-то конкретное:
    1. Модули верхних уровней, не должны зависеть от нижних модулей. Оба модуля должны зависеть от абстракций.
